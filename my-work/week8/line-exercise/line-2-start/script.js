...
function gotData(incomingData){
  ...
  let flatData = d3.merge(incomingData)//2 elements to 132 elements
...
// console.log(incomingData[0][0]);
  // let dataToShow= incomingData[dataIndex];
function countrySwitch(){

  graphGroup.selectAll(".line").data([incomingData[dataIndex]],function(d,i){
    return d.year;
  }).enter()
    .append("path")
    .classed("line",true)
    ...
    .attr("stroke",function(d,i){
      console.log("index",incomingData[dataIndex]);
      console.log("d",d);
